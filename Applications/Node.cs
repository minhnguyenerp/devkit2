...
namespace devkit2.Applications
{
    internal sealed class Node : BaseApplication
    {
        ...
        public override bool Install(string version, IProgress<InstallProgress>? progress = null)
        {
            ...
            switch (version)
            {
                case "24.16.0": url = "https://nodejs.org/dist/v24.16.0/node-v24.16.0-win-x64.zip"; break;
                case "24.15.0": url = "https://nodejs.org/dist/v24.15.0/node-v24.15.0-win-x64.zip"; break;
                case "24.14.1": url = "https://nodejs.org/dist/v24.14.1/node-v24.14.1-win-x64.zip"; break;
                case "24.14.0": url = "https://nodejs.org/dist/v24.14.0/node-v24.14.0-win-x64.zip"; break;
            }
            file = Path.Combine(Path.GetTempPath(), $"node-v{version}-win-x64.zip");
