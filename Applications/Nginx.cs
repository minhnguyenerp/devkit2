...
namespace devkit2.Applications
{
    internal sealed class Nginx : BaseApplication
    {
        ...
        public override bool Install(string version, IProgress<InstallProgress>? progress = null)
        {
            ...
            switch (version)
            {
                case "1.30.2": url = "https://nginx.org/download/nginx-1.30.2.zip"; break;
                case "1.30.0": url = "https://nginx.org/download/nginx-1.30.0.zip"; break;
                case "1.28.2": url = "https://nginx.org/download/nginx-1.28.2.zip"; break;
            }
            file = Path.Combine(Path.GetTempPath(), $"nginx-{version}.zip");
