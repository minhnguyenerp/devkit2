...
namespace devkit2.Applications
{
    internal sealed class Php : BaseApplication
    {
        ...
        public override bool Install(string version, IProgress<InstallProgress>? progress = null)
        {
            ...
            {
                case "8.5.6":
                    url = "https://downloads.php.net/~windows/releases/archives/php-8.5.6-Win32-vs17-x64.zip";
                    file = Path.Combine(Path.GetTempPath(), "php-8.5.6-Win32-vs17-x64.zip");
