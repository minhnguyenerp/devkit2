...
{
    internal sealed class RustMsvc : BaseApplication
    {
        public override string Name => "RustMsvc";

        public RustMsvc()
        {
            appPath = Path.Combine(BaseApplication.LocalApplicationData, "apps", "rustmsvc");
        ...
        public override void ReloadIcon()
        {
            try
            {
                base.Icon = Resources.rust_blue_icon;
            }
            catch { }
        }
        ...
        public override bool Install(string version, IProgress<InstallProgress>? progress = null)
        {
            ...
            {
                case "1.95.0":
                    url = "https://static.rust-lang.org/dist/rust-1.95.0-x86_64-pc-windows-msvc.tar.xz";
                    file = Path.Combine(Path.GetTempPath(), "rust-1.95.0-x86_64-pc-windows-msvc.tar.xz");
                    break;
                case "1.94.1":
                    url = "https://static.rust-lang.org/dist/rust-1.94.1-x86_64-pc-windows-msvc.tar.xz";
                    file = Path.Combine(Path.GetTempPath(), "rust-1.94.1-x86_64-pc-windows-msvc.tar.xz");
                    break;
                case "1.94.0":
                    url = "https://static.rust-lang.org/dist/rust-1.94.0-x86_64-pc-windows-msvc.tar.xz";
                    file = Path.Combine(Path.GetTempPath(), "rust-1.94.0-x86_64-pc-windows-msvc.tar.xz");
                    break;
            }
