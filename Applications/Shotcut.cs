...
{
    internal sealed class Shotcut : BaseApplication
    {
        public override string Name => "Shotcut";

        public Shotcut()
        {
            appPath = Path.Combine(BaseApplication.LocalApplicationData, "apps", "shotcut");
        ...
        public override void ReloadIcon()
        {
            try
            {
                base.Icon = Icon.ExtractAssociatedIcon(Path.Combine(appPath, InstalledVersions[0].Value, "Shotcut", "shotcut.exe"));
            }
            catch { }
        }
        ...
        {
            return new ValueName[] {
                new ValueName("PATH", Path.Combine(appPath, version, "Shotcut")),
            };
        }
        ...
        public override bool Start(string version, ValueName[] environments, JsonObject? profile = null, string uniqueCode = "")
        {
            ...
            psi.FileName = Path.Combine(appPath, version, "Shotcut", "shotcut.exe");
