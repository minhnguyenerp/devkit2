...
namespace devkit2.Applications
{
    internal sealed class Bruno : BaseApplication
    {
        ...
        public override bool Install(string version, IProgress<InstallProgress>? progress = null)
        {
            ...
            {
                case "3.4.2":
                    url = "https://github.com/usebruno/bruno/releases/download/v3.4.2/bruno_3.4.2_x64_win.zip";
                    file = Path.Combine(Path.GetTempPath(), "bruno_3.4.2_x64_win.zip");
                    break;
                case "3.3.0":
