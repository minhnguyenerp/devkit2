...
{
    internal sealed class Bitwarden : BaseApplication
    {
        public override string Name => "Bitwarden";

        public Bitwarden()
        {
            appPath = Path.Combine(BaseApplication.LocalApplicationData, "apps", "bitwarden");
        ...
        public override void ReloadIcon()
        {
            try
            {
                base.Icon = Icon.ExtractAssociatedIcon(Path.Combine(appPath, InstalledVersions[0].Value, $"Bitwarden-Portable-{InstalledVersions[0].Value}.exe"));
            }
            catch { }
        }
        ...
        public override bool Start(string version, ValueName[] environments, JsonObject? profile = null, string uniqueCode = "")
        {
            ...
            psi.FileName = Path.Combine(appPath, version, $"Bitwarden-Portable-{version}.exe");
