...
namespace devkit2.Applications
{
    internal sealed class Npp : BaseApplication
    {
        ...
        public override bool Install(string version, IProgress<InstallProgress>? progress = null)
        {
            ...
            switch (version)
            {
                case "8.9.6.2": url = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.9.6.2/npp.8.9.6.2.portable.x64.zip"; break;
                case "8.9.4": url = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.9.4/npp.8.9.4.portable.x64.zip"; break;
                case "8.9.3": url = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.9.3/npp.8.9.3.portable.x64.zip"; break;
                case "8.9.2": url = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.9.2/npp.8.9.2.portable.x64.zip"; break;
            }
            file = Path.Combine(Path.GetTempPath(), $"npp.{version}.portable.x64.zip");
