...
{
    internal sealed class Processing : BaseApplication
    {
        public override string Name => "Processing";

        public Processing()
        {
            appPath = Path.Combine(BaseApplication.LocalApplicationData, "apps", "processing");
        ...
        public override void ReloadIcon()
        {
            try
            {
                base.Icon = Icon.ExtractAssociatedIcon(Path.Combine(appPath, InstalledVersions[0].Value, "Processing", "Processing.exe"));
            }
            catch { }
        }
        ...
        {
            return new ValueName[] {
                new ValueName("PATH", Path.Combine(appPath, version, "Processing")),
            };
        }
        ...
        public override bool Start(string version, ValueName[] environments, JsonObject? profile = null, string uniqueCode = "")
        {
            ...
            psi.FileName = Path.Combine(appPath, version, "Processing", "Processing.exe");
