...
{
    internal sealed class Thonny : BaseApplication
    {
        public override string Name => "Thonny";

        public Thonny()
        {
            appPath = Path.Combine(BaseApplication.LocalApplicationData, "apps", "thonny");
        ...
        public override void ReloadIcon()
        {
            try
            {
                base.Icon = Icon.ExtractAssociatedIcon(
                    Path.Combine(appPath, InstalledVersions[0].Value, "thonny.exe")
                );
            }
            catch { }
        }
        ...
        public override bool Start(string version, ValueName[] environments, JsonObject? profile = null, string uniqueCode = "")
        {
            ...
            psi.FileName = Path.Combine(appPath, version, "thonny.exe");
