    ...
    internal sealed class RustGcc : BaseApplication
    {
        ...
        public override ValueName[] AvailableVersions
        {
            get
            {
                ...
                {
                    new ValueName("1.97.1", "1.97.1") { Tag = "https://static.rust-lang.org/dist/rust-1.97.1-x86_64-pc-windows-gnu.tar.xz" },
                    new ValueName("1.96.0", "1.96.0") { Tag = "https://static.rust-lang.org/dist/rust-1.96.0-x86_64-pc-windows-gnu.tar.xz" },
                    new ValueName("1.95.0", "1.95.0") { Tag = "https://static.rust-lang.org/dist/rust-1.95.0-x86_64-pc-windows-gnu.tar.xz" },
                    new ValueName("1.94.1", "1.94.1") { Tag = "https://static.rust-lang.org/dist/rust-1.94.1-x86_64-pc-windows-gnu.tar.xz" },
                    new ValueName("1.94.0", "1.94.0") { Tag = "https://static.rust-lang.org/dist/rust-1.94.0-x86_64-pc-windows-gnu.tar.xz" },
                };
            }
        }
        ...
        public override bool Install(string version, IProgress<InstallProgress>? progress = null)
        {
            ...
            file = Path.Combine(Path.GetTempPath(), $"rust-{version}-x86_64-pc-windows-gnu.tar.xz");
